...
<Tabs>
  ...
  <Tab title="Studios">
    ...
    * **Performance Enhancements**: The Game Bot will regularly review performance of live campaigns. When users log into the application, the AI will suggest ways to improve performance and conversions. As The Game Bot
  </Tab>
