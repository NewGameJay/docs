...
<CardGroup cols={2}>
  <Card title="Blockchain Integration" icon="ethereum" href="https://docs.newgame.me/app/blockchain-integration">
...
All payments in Escrow can be viewed by both parties and reported if there is any dispute or concern. Past claims and payouts can also be reviewed in the Payout Portal by both parties for tax use or payment confirmation. <Accordion title="Fiat Payments">
